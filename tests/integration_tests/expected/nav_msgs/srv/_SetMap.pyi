...
class SetMapRequest(genpy.Message):
    ...
    def deserialize(self, str: str) -> SetMapRequest: ...
    def serialize_numpy(self, buff: typing.StringIO, numpy: types.ModuleType) -> None: ...
    def deserialize_numpy(self, str: str, numpy: types.ModuleType) -> SetMapRequest: ...
...
class SetMapResponse(genpy.Message):
    ...
    def _get_types(self) -> typing.List[str]: ...
    def serialize(self, buff: typing.StringIO) -> None: ...
    def deserialize(self, str: str) -> SetMapResponse: ...
    def serialize_numpy(self, buff: typing.StringIO, numpy: types.ModuleType) -> None: ...
    def deserialize_numpy(self, str: str, numpy: types.ModuleType) -> SetMapResponse: ...
